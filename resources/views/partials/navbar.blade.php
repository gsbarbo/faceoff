                ...
                @auth
                    <div x-data="{ open:false }">
                        ...
                        <div
                            ...
                            @mouseleave="open = false"
                            x-transition
                            class="absolute bg-white shadow-lg border rounded p-2 mt-2 w-40 z-50"
                        >
                            <a href="#" class="block px-3 py-1 hover:bg-gray-100 rounded">Player Area</a>
                            <a href="#" class="block px-3 py-1 hover:bg-gray-100 rounded">Admin Area</a>
                            <a href="#" class="block px-3 py-1 hover:bg-gray-100 rounded">Settings</a>
                            <hr>
                            <form action="{{ route('logout') }}" class="block px-3 py-1 hover:bg-gray-100 rounded"
                                  method="POST">
                                @csrf
                                <a class=""
                                   href="#"
